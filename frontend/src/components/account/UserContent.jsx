// src/components/account/UserContent.jsx
...
const UserContent = ({ user, watchlist = [], likedContent = [], recentComments = [] }) => {
  ...
  return (
    <div>
      ...
      >
        <TabPane 
          tab={<span className="text-white"><ClockCircleOutlined /> Watch Later</span>} 
          key="watchlist"
        >
          {watchlist.length > 0 ? (
            <List
        ...
        <TabPane 
          tab={<span className="text-white"><HeartOutlined /> Liked</span>} 
          key="liked"
        >
        ...
        <TabPane 
          tab={<span className="text-white"><CommentOutlined /> Recent Comments</span>} 
          key="comments"
        >
